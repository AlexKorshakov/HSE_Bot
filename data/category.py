...
MAIN_CATEGORY_LIST: list[str] = ["Охрана труда",
...
CATEGORY_LIST: list[str] = ['Охрана труда_',
...
VIOLATION_CATEGORY: list[str] = ["Происшествие без последствий*",
                                 "Опасные действия*",
                                 "Травма*",
                                 "Опасная ситуация*",
                                 "FAT*",
...
GENERAL_CONTRACTORS: list[str] = ["Строй-Монтаж 2002",
                                  "МИП - Строй 1",
                                  "СиАрСиСи Рус",
                                  "ГорИнжПроект"]