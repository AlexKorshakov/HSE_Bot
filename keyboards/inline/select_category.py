...
async def select_category(message: types.Message, *, some_list, num_col=1) -> None:
    ...
    reply_markup = types.InlineKeyboardMarkup(resize_keyboard=True, inline_keyboard=menu)
